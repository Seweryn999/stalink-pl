...
export default function AiServicesSection() {
  ...
  return (
    <>
      <motion.section
        id="automatyzacja-ai"
        className="bg-gradient-to-b from-blue-50 to-blue-100/60 flex flex-col justify-center min-h-screen pt-20 md:pt-32 pb-12"
        initial="hidden"
        whileInView="visible"
      ...
      <section className="bg-blue-500/90 py-20">
