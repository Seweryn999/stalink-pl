...
export default function ProjectsPage() {
  return (
    <>
      <Header />
      <section className="min-h-screen py-20 sm:py-32 lg:py-40 flex justify-center bg-[#0a0e1f] text-white">
        <div className="max-w-7xl w-full px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center gap-y-16">
          <link rel="icon" href="/logo.svg" />
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black uppercase tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-cyan-400">
            Projekty Komercyjne
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 p-4 w-full">
            ...
            {["Wolne miejsce", "Wolne miejsce"].map((title, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <div className="aspect-square relative w-full flex items-center justify-center bg-white/[0.04]">
                ...
                <div className="relative p-4 flex flex-col items-center bg-white/[0.03] rounded-b-xl">
                  ...
                  <p className="text-slate-300 text-sm leading-relaxed text-center mt-4 mb-4">
      ...
      <section className="min-h-[120vh] py-40 flex justify-center items-center text-white bg-[#070a17]">
        <div className="max-w-7xl w-full px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center gap-y-16">
          <motion.h2
            className="text-4xl sm:text-5xl lg:text-6xl font-black uppercase tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-cyan-400"
            variants={fadeInVariants}
            initial="hidden"
            animate="visible"
          ...
          <div className="!pt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 p-4 w-full">
            {[
              ...
              <motion.div
                key={index}
                className="relative bg-white/[0.04] rounded-xl shadow-lg transition-all duration-300 overflow-hidden group mx-auto w-full max-w-[250px] border border-cyan-400/25 hover:shadow-[0_0_25px_rgba(34,211,238,0.4)] hover:scale-105"
                variants={fadeInVariants}
                initial="hidden"
                whileInView="visible"
                ...
                <div className="relative p-4 flex flex-col items-center rounded-b-xl">
                  ...
                  <div className="flex gap-4 mt-4">
                    <a
                      ...
                      className="px-4 py-2 bg-cyan-500 text-white rounded-md font-medium hover:bg-cyan-400 transition-all duration-200"
                    >
                      Repozytorium
                    </a>
                    <a
